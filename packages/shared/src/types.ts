...
export const AGENT_CONFIG: Record<Agent, { label: string; color: string }> = {
  ...
  todd: { label: 'Todd', color: '#06b6d4' },  // cyan
...
export type Status = 'planning' | 'todo' | 'in_progress' | 'qa' | 'pr_review' | 'done';

export const STATUSES: Status[] = ['planning', 'todo', 'in_progress', 'qa', 'pr_review', 'done'];
